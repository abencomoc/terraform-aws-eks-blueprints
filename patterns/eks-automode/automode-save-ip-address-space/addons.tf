...
#---------------------------------------------------------------
# EKS Pod Identity for fluentbit pods
#---------------------------------------------------------------

# EKS Pod Identity is still not supported by aws-fluent-bit - https://github.com/aws/aws-for-fluent-bit/issues/784
# using IRSA in the meantime
# module "fluentbit_pod_identity" {
#   source = "terraform-aws-modules/eks-pod-identity/aws"

#   name = "fluentbit_pod_identity"
